    ...
    return {
        ...
        post: function post(file) {
            ...
            if (opts.messagesDir && descriptors.length > 0) {
                ...
                var currentFilename = messagesFilename; //.replace('-tmp', '');
                var currentMessages = void 0;
                if ((0, _fs.existsSync)(currentFilename)) {
                    currentMessages = JSON.parse((0, _fs.readFileSync)(currentFilename));
                }

                var output = descriptors.reduce(function (outputObj, message) {
                    var id = message.id,
                    ...
                    if (!currentMessages || !currentMessages[id]) {
                        outputMessage.reviewRequired = true, outputMessage.previousDefaultMessage = '';
                    }
                ...
                var messagesFile = (0, _stringify2.default)(output, null, 2);
